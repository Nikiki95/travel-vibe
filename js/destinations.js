// TravelVibe Destinations Database - CORE VERSION
// Sources: Unsplash (free photos)
// 8 Core destinations + Utilities
...
const destinations = [
    {
        ...
        experience: 'Peaceful, almost meditative. You feel small but grounded. Like the forest is breathing with you.',
        ...
        tips: ['Go early morning before crowds', 'Wear comfortable shoes', 'Bring a light jacket', 'Listen to the bamboo rustle'],
        rating: 4.8,
        vibe: 'peaceful'
    },
    {
        ...
        experience: 'Intimate, like discovering art meant just for you. Time slows down.',
        ...
        tips: ['Visit on weekday mornings', 'Skip the Mona Lisa crowds', 'Get a museum map', 'Explore lesser-known wings'],
        rating: 4.6,
        vibe: 'cultural'
    },
    {
        ...
        experience: 'Surreal, cyberpunk, like you have stepped into a movie. Quiet power.',
        ...
        media: {
            ...
            photos: [
                ...
                'https://images.unsplash.com/photo-1505852679233-d9fd5278969f?w=800&q=80'
            ],
            clip: null
        },
        tips: ['Bring a camera with night settings', 'Wear warm clothes', 'Walk around back streets', 'Capture the neon reflections'],
        rating: 4.7,
        vibe: 'adventurous'
    },
    {
        ...
        category: 'culinary',
        description: 'A sensory explosion. Mountains of spices in every color. Vendors calling out. The smell hits you before you see it.',
    ...
    },
    {
        ...
        tips: ['Tip the divers if you watch', 'Watch sunset from the bridge', 'Explore old town after dark', 'Learn the bridge history'],
        rating: 4.9,
        vibe: 'scenic'
    },
    {
        ...
        category: 'nature',
        description: 'Towering sandstone pillars rising through clouds. You literally stand above the clouds. Inspired Avatar.',
        experience: 'Otherworldly, humbling. Like you have stepped into another planet.',
    ...
    },
    {
        ...
        category: 'museum',
        description: 'White marble infinity. You can walk on the roof. The acoustics inside are mind-blowing.',
        ...
        tips: ['Free to explore exterior', 'Check for performances', 'Come at different times of day', 'Walk on the marble roof'],
        rating: 4.7,
        vibe: 'cultural'
    },
    {
        ...
        location: 'Ubud, Bali',
        category: 'nature',
        description: 'Emerald green rice paddies carved into hillsides. Ancient irrigation system. Walk through them like paintings.',
        ...
        tips: ['Hike through terraces early morning', 'Wear good shoes', 'Support local farmers', 'Bring water